...
/*
    class MyVideoFrameMetadataListener(private val detector: MyBodyDetector) : VideoFrameMetadataListener {
        ...
        override fun onVideoFrameAboutToBeRendered(
            ...
            // 将视频帧的元数据传递给您的人体动作检测模型进行检测
            val image = (surface as Surface).lockHardwareCanvas().let { canvas ->
            ...
            val bodyPoints = detector.detectBodyPoints(image)
            // 根据检测结果进行其他处理
        }
...
// 设置监听器
    exoPlayer.addVideoFrameMetadataListener(MyVideoFrameMetadataListener(myBodyDetector))
*/
